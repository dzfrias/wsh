...
use thiserror::Error;
use tracing::debug;
use wsh_parser::{BlockType, InstrBufferRef, Instruction};
    ...
    fn compile_buf(
        ...
        while i < buf.len() {
            ...
            match instr {
                ...
                I::I32GeU => binop!(geu U32 or geu),
                I::I64GeU => binop!(geu U64 or geu),
                I::I32ShrS => binop!(shrs U32 or shrs),
                I::I64ShrS => binop!(shrs U64 or shrs),
                I::I32ShrU => binop!(shru U32 or shru),
                I::I64ShrU => binop!(shru U64 or shru),
...
#[cfg(test)]
mod tests {
    use wsh_parser::{Block, BlockType, Code, FuncType, InstrBuffer, ValType};
