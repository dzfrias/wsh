...
use wsh_parser::{BlockType, InitExpr, InstrBuffer, RefType};
...
mod tests {
    use crate::Store;
    use test_log::test;
    use wsh_parser::Instruction::*;
    use wsh_parser::{Code, FuncType, Function, Module, ValType};
    use Value::*;
